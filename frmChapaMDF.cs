...
{
    public partial class frmChapaMDF : MetroFramework.Forms.MetroForm
    {
        public frmChapaMDF()
        {
            InitializeComponent();
        ...
        private void frmChapaMDF_Load(object sender, EventArgs e)
        {
            ...
            //    comando.CommandText = "CREATE TABLE tabelaChapaMDF (codigo NVARCHAR(20) NOT NULL PRIMARY KEY, espessura NVARCHAR(100), faces NVARCHAR(10) , descricao NVARCHAR(100))";
        ...
        public void AtualizarTabela()
        {
            ...
            try
            {
                string query = "SELECT * FROM tabelaChapaMDF";
                    ...
                    using (StreamReader reader = new StreamReader(filename))
                    {
                        while (!reader.EndOfStream)
                        {
                            ...
                            if (linenumber != 0)
                            {
                                ...
                                var sql = "INSERT INTO tabelaChapaMDF VALUES (" + values[0].ToString().Trim() + " , '" + values[1].ToString().Trim() + "'  , '" + values[2].ToString().Trim() + "' , '" + values[3].ToString().Trim() + "' )";
        ...
        private void btnExcluir_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                try
                {
                    ...
                    comando.CommandText = "DELETE FROM tabelaChapaMDF WHERE codigo = '" + codigo + "'";
                    comando.ExecuteNonQuery();
