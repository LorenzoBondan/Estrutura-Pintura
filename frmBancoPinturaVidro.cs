...
{
    public partial class frmBancoPinturaVidro : MetroFramework.Forms.MetroForm
    {
        public frmBancoPinturaVidro()
        {
            InitializeComponent();
        ...
        private void frmBancoPinturaVidro_Load(object sender, EventArgs e)
        {
            ...
            //    comando.CommandText = "CREATE TABLE tabelaPinturaAcetinadaVidros1F (codigo NVARCHAR(20) NOT NULL PRIMARY KEY, cor NVARCHAR(100), descricao NVARCHAR(100))";
        ...
        public void AtualizarTabela()
        {
            ...
            try
            {
                string query = "SELECT * FROM tabelaPinturaAcetinadaVidros1F";
                    ...
                    using (StreamReader reader = new StreamReader(filename))
                    {
                        while (!reader.EndOfStream)
                        {
                            ...
                            if (linenumber != 0)
                            {
                                ...
                                var sql = "INSERT INTO tabelaPinturaAcetinadaVidros1F VALUES (" + values[0].ToString().Trim() + " , '" + values[1].ToString().Trim() + "'  , '" + values[2].ToString().Trim() + "' )";
        ...
        private void btnExcluir_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                try
                {
                    ...
                    comando.CommandText = "DELETE FROM tabelaPinturaAcetinadaVidros1F WHERE codigo = '" + codigo + "'";
                    comando.ExecuteNonQuery();
